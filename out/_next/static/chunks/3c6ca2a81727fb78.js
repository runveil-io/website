...
// 5. Lower prices → equilibrium`}),(0,s.jsx)(d,{children:`         PRICE
     ...
     0.30 -+ - - -/- - - - - \\- - floor
           ...
           +-----+--------------+---> TIME
                 ^              ^
              high demand    supply responds`})]}),(0,s.jsxs)(l,{id:"settlement",number:"8",title:"Settlement",children:[(0,s.jsx)("h3",{className:"mb-3 font-bold text-foreground",children:"8.1 Optimistic Model"}),(0,s.jsx)("p",{className:"mb-4",children:"Veil Protocol uses optimistic settlement—transactions are assumed valid unless challenged. This reduces on-chain overhead dramatically: only one witness per batch is submitted, rather than individual transaction proofs."}),(0,s.jsx)("p",{className:"mb-6",children:"The model is inspired by optimistic rollups but adapted for inference workloads. Most settlements complete without challenge. The fraud proof system exists for the rare cases where disputes arise."}),(0,s.jsx)("h3",{className:"mb-3 font-bold text-foreground",children:"8.2 Settlement Flow"}),(0,s.jsx)(d,{children:`+------------------------------------------------------+
|                  SETTLEMENT FLOW                     |
+------------------------------------------------------+
|                                                      |
...
Cooldown: 90 days between offense levels`})]}),(0,s.jsxs)(l,{id:"token-economics",number:"9",title:"Token Economics",children:[(0,s.jsx)("h3",{className:"mb-3 font-bold text-foreground",children:"9.1 Three Phases"}),(0,s.jsxs)("ul",{className:"mb-6 list-inside list-disc",children:[(0,s.jsxs)("li",{className:"mb-2",children:[(0,s.jsx)("strong",{className:"text-foreground",children:"Phase 0 (M0-M3)"}),": Points + USDC. Providers earn USDC (80%) + Points. No token yet."]}),(0,s.jsxs)("li",{className:"mb-2",children:[(0,s.jsx)("strong",{className:"text-foreground",children:"Phase 1 (M4-M6)"}),": TGE. Points convert to TOKEN. Elastic release begins."]}),(0,s.jsxs)("li",{className:"mb-2",children:[(0,s.jsx)("strong",{className:"text-foreground",children:"Phase 2 (M6+)"}),": Full tokenomics. Staking, governance, burn mechanism active."]})]}),(0,s.jsx)("h3",{className:"mb-3 font-bold text-foreground",children:"9.2 Supply Distribution"}),(0,s.jsx)(c,{children:`Total Supply: 1,000,000,000 TOKEN (fixed)
...
|                                                      |
+------------------------------------------------------+`}),(0,s.jsx)("h3",{className:"mb-3 font-bold text-foreground",children:"9.5 Buyback & Burn"}),(0,s.jsx)(c,{children:`Buyback Phases:
